...
| `interim-site-data.v2` | completed-window primary panels plus nested-validation sweeps, correlation scatters, direct tanh age, distance integration, and validation-only t-SNE; cannot substitute for `site-data.v1` |
